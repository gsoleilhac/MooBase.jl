/**
 * \file moo/minimum_set.hpp
 * \brief A class for managing a set of efficient solutions, with equivalent
 *        ones.
 * \author Julien Jorge
 */
#ifndef __MOO_MINIMUM_SET_HPP__
#define __MOO_MINIMUM_SET_HPP__
...
namespace moo
{
  ...
  public:
    ...
    typedef minimum_set<Solution> self_type;
...
#include <moo/impl/minimum_set.tpp>

#endif // __MOO_MINIMUM_SET_HPP__
