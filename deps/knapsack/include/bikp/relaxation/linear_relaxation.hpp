...
*/
/**
 * \file linear_relaxation.hpp
 * \brief The linear_relaxation class compute an upper bound on a mono-objective
 *        problem using the classic linear relaxation.
 * \author Julien Jorge
 */
#ifndef __BIKP_LINEAR_RELAXATION_HPP__
#define __BIKP_LINEAR_RELAXATION_HPP__
...
#include "bikp/relaxation/impl/linear_relaxation.tpp"

#endif // __BIKP_LINEAR_RELAXATION_HPP__
