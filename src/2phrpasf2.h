...
/** \typedef structure indiquant les donnees du probleme : les matrices des 2 fonctions objectif et leur taille */

typedef struct
{
short int C1[SizeMax][SizeMax];
short int C2[SizeMax][SizeMax];
short int nSize;
} donnees;
